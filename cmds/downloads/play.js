...
async function getAudioFromApis(url) {
  const apis = [
    ...
    { api: 'Stellar', endpoint: `${global.APIs.stellar.url}/dl/youtubeplayv2?query=${encodeURIComponent(url)}&type=mp3&quality=auto&key=nekotina`, extractor: res => res.result?.download },
